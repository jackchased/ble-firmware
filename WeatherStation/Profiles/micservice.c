...
#define SENSOR_SERVICE_UUID     MIC_SERV_UUID
#define SENSOR_DATA_UUID        MIC_DATA_UUID
#define SENSOR_CONFIG_UUID      MIC_CONF_UUID
#define SENSOR_PERIOD_UUID      MIC_PERI_UUID

#define SENSOR_SERVICE          MIC_SERVICE
#define SENSOR_DATA_LEN         MIC_DATA_LEN

#define SENSOR_DATA_DESCR       "Mic. Data"
#define SENSOR_CONFIG_DESCR     "Mic. Conf."
#define SENSOR_PERIOD_DESCR     "Mic. Period"
 ...
 */
bStatus_t Mic_AddService( uint32 services )
{
 ...
 */
bStatus_t Mic_RegisterAppCBs( sensorCBs_t *appCallbacks )
{
 ...
 * @return  bStatus_t
 */
bStatus_t Mic_SetParameter( uint8 param, uint8 len, void *value )
{
 ...
 * @return  bStatus_t
 */
bStatus_t Mic_GetParameter( uint8 param, void *value )
{
  bStatus_t ret = SUCCESS;
