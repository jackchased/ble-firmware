...
#define SENSOR_SERVICE_UUID     AIN_SERV_UUID
#define SENSOR_DATA_UUID        AIN_DATA_UUID
#define SENSOR_CONFIG_UUID      AIN_CONF_UUID
#define SENSOR_PERIOD_UUID      AIN_PERI_UUID

#define SENSOR_SERVICE          AIN_SERVICE
#define SENSOR_DATA_LEN         AIN_DATA_LEN

#define SENSOR_DATA_DESCR       "AIN Voltage(mV)"
#define SENSOR_CONFIG_DESCR     "AIN Conf."
#define SENSOR_PERIOD_DESCR     "AIN Period"
 ...
 */
bStatus_t Ain_AddService( uint32 services )
{
 ...
 */
bStatus_t Ain_RegisterAppCBs( sensorCBs_t *appCallbacks )
{
 ...
 * @return  bStatus_t
 */
bStatus_t Ain_SetParameter( uint8 param, uint8 len, void *value )
{
 ...
 * @return  bStatus_t
 */
bStatus_t Ain_GetParameter( uint8 param, void *value )
{
  bStatus_t ret = SUCCESS;
