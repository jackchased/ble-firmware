...
#define SENSOR_DATA1              4       // RN uint8 - Profile Attribute value
#define SENSOR_CONF1              5       // RW uint8 - Profile Attribute value
#define SENSOR_PERI1              6       // RW uint8 - Profile Attribute value

#define SENSOR_DATA2              7       // RN uint8 - Profile Attribute value
#define SENSOR_CONF2              8       // RW uint8 - Profile Attribute value
#define SENSOR_PERI2              9       // RW uint8 - Profile Attribute value

#define SENSOR_DATA3              10      // RN uint8 - Profile Attribute value
#define SENSOR_CONF3              11      // RW uint8 - Profile Attribute value
#define SENSOR_PERI3              12      // RW uint8 - Profile Attribute value
