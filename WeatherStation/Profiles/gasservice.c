...
#define SENSOR_SERVICE_UUID     GAS_SERV_UUID
#define SENSOR_DATA_UUID        GAS_DATA_UUID
#define SENSOR_CONFIG_UUID      GAS_CONF_UUID
#define SENSOR_PERIOD_UUID      GAS_PERI_UUID

#define SENSOR_SERVICE          GAS_SERVICE
#define SENSOR_DATA_LEN         GAS_DATA_LEN

#define SENSOR_DATA_DESCR       "MQ7 Data"
#define SENSOR_CONFIG_DESCR     "MQ7 Conf."    
#define SENSOR_PERIOD_DESCR     "MQ7 Period"
...
// Service UUID
static CONST uint8 sensorServiceUUID[ATT_BT_UUID_SIZE] =
{ 
  LO_UINT16(SENSOR_SERVICE_UUID), HI_UINT16(SENSOR_SERVICE_UUID)
};

// Characteristic UUID: data
static CONST uint8 sensorDataUUID[ATT_BT_UUID_SIZE] =
{ 
  LO_UINT16(SENSOR_DATA_UUID), HI_UINT16(SENSOR_DATA_UUID)
};

// Characteristic UUID: config
static CONST uint8 sensorCfgUUID[ATT_BT_UUID_SIZE] =
{ 
  LO_UINT16(SENSOR_CONFIG_UUID), HI_UINT16(SENSOR_CONFIG_UUID)
};

// Characteristic UUID: period
static CONST uint8 sensorPeriodUUID[ATT_BT_UUID_SIZE] =
{ 
  LO_UINT16(SENSOR_PERIOD_UUID), HI_UINT16(SENSOR_PERIOD_UUID)
};
...
static CONST gattAttrType_t sensorService = { ATT_BT_UUID_SIZE, sensorServiceUUID };
...
static gattAttribute_t sensorAttrTable[] = 
{
  ...
  { 
    ...
    { 
      ...
      // Characteristic Value "Data"
      { 
        { ATT_BT_UUID_SIZE, sensorDataUUID },
        GATT_PERMIT_READ,
        0, 
        sensorData 
      },
...
CONST gattServiceCBs_t sensorCBs =
{
 ...
 * @fn      Gas_AddService
 *
 * @brief   Initializes the Umbrella service by registering
 ...
 */
bStatus_t Gas_AddService( uint32 services )
{
 ...
 */
bStatus_t Gas_RegisterAppCBs( sensorCBs_t *appCallbacks )
{
 ...
 * @return  bStatus_t
 */
bStatus_t Gas_SetParameter( uint8 param, uint8 len, void *value )
{
 ...
 * @return  bStatus_t
 */
bStatus_t Gas_GetParameter( uint8 param, void *value )
{
  bStatus_t ret = SUCCESS;
 ...
 *
 * @brief       Gas Profile link status change handler function.
 *
