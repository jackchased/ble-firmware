...
#define SENSOR_SERVICE_UUID     PIR_SERV_UUID
#define SENSOR_DATA_UUID        PIR_DATA_UUID

#define SENSOR_SERVICE          PIR_SERVICE
 ...
 */
bStatus_t Pir_RegisterAppCBs( sensorCBs_t *appCallbacks )
{
 ...
 * @return  bStatus_t
 */
bStatus_t Pir_GetParameter( uint8 param, void *value )
{
  bStatus_t ret = SUCCESS;
