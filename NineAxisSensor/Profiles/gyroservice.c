...
#define SENSOR_DATA1_UUID       ACCELEROMETER_DATA_UUID

#define SENSOR_SERVICE          GYROSCOPE_SERVICE
#define SENSOR_DATA_LEN         GYROSCOPE_DATA_LEN
#define SENSOR_DATA1_LEN        ACCELEROMETER_DATA_LEN

#define SENSOR_DATA_DESCR       "Gyro Data"
#define SENSOR_CONFIG_DESCR     "Gyro and Accel Conf."
#define SENSOR_PERIOD_DESCR     "Gyro and Accel Period"
#define SENSOR_DATA1_DESCR      "Accel Data"
...
static uint8 sensorData1[SENSOR_DATA1_LEN] = { 0, 0, 0, 0, 0, 0};
