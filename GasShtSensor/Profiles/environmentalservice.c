...
#define SENSOR_DATA_UUID         TEMP_DATA_UUID
#define SENSOR_DATA1_UUID        HUMI_DATA_UUID
#define SENSOR_CONFIG_UUID       TEMP_CONF_UUID
#define SENSOR_PERIOD_UUID       TEMP_PERI_UUID

#define SENSOR_SERVICE           ENVIRONMENTAL_SERVICE
#define SENSOR_DATA_LEN          TEMP_DATA_LEN
#define SENSOR_DATA1_LEN         HUMI_DATA_LEN

#define SENSOR_DATA_DESCR        "Temp. Data"
#define SENSOR_DATA1_DESCR       "Humi. Data"
#define SENSOR_CONFIG_DESCR      "SHT20. Conf."
#define SENSOR_PERIOD_DESCR      "SHT20. Period"
