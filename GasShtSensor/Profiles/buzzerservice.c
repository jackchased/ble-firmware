...
#define SENSOR_SERVICE_UUID     BUZZER_SERV_UUID
#define SENSOR_DATA_UUID        BUZZER_DATA_UUID
#define SENSOR_CONFIG_UUID      BUZZER_CONF_UUID
#define SENSOR_PERIOD_UUID      BUZZER_PERI_UUID

#define SENSOR_SERVICE          BUZZER_SERVICE
#define SENSOR_DATA_LEN         BUZZER_DATA_LEN

#define SENSOR_DATA_DESCR       "Buzzer Status"
#define SENSOR_CONFIG_DESCR     "Buzzer Conf."
#define SENSOR_PERIOD_DESCR     "Buzzer Period"
 ...
 */
bStatus_t Buzzer_AddService( uint32 services )
{
 ...
 */
bStatus_t Buzzer_RegisterAppCBs( sensorCBs_t *appCallbacks )
{
 ...
 * @return  bStatus_t
 */
bStatus_t Buzzer_SetParameter( uint8 param, uint8 len, void *value )
{
 ...
 * @return  bStatus_t
 */
bStatus_t Buzzer_GetParameter( uint8 param, void *value )
{
  bStatus_t ret = SUCCESS;
