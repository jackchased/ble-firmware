...
#define SENSOR_SERVICE_UUID     DIN_SERV_UUID
#define SENSOR_DATA_UUID        DIN_DATA_UUID

#define SENSOR_SERVICE          DIN_SERVICE
#define SENSOR_DATA_LEN         DIN_DATA_LEN

#define SENSOR_DATA_DESCR       "DIN Status"
 ...
 */
bStatus_t Din_AddService( uint32 services )
{
 ...
 */
bStatus_t Din_RegisterAppCBs( sensorCBs_t *appCallbacks )
{
 ...
 * @return  bStatus_t
 */
bStatus_t Din_SetParameter( uint8 param, uint8 len, void *value )
{
 ...
 * @return  bStatus_t
 */
bStatus_t Din_GetParameter( uint8 param, void *value )
{
  bStatus_t ret = SUCCESS;
