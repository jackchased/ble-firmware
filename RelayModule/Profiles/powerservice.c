...
#define SENSOR_SERVICE_UUID     POWER_SERV_UUID
#define SENSOR_DATA_UUID        POWER_DATA_UUID
#define SENSOR_CONFIG_UUID      POWER_CONF_UUID
#define SENSOR_PERIOD_UUID      POWER_PERI_UUID
#define SENSOR_DATA1_UUID       CURRENT_DATA_UUID

#define SENSOR_SERVICE          POWER_SERVICE
#define SENSOR_DATA_LEN         POWER_DATA_LEN
#define SENSOR_DATA1_LEN        CURRENT_DATA_LEN

#define SENSOR_DATA_DESCR       "Power Data"
#define SENSOR_CONFIG_DESCR     "Power and Current Conf."
#define SENSOR_PERIOD_DESCR     "Power and Current Period"
#define SENSOR_DATA1_DESCR      "Current Data"
 ...
 */
bStatus_t Power_AddService( uint32 services )
{
 ...
 */
bStatus_t Power_RegisterAppCBs( sensorCBs_t *appCallbacks )
{
 ...
 * @return  bStatus_t
 */
bStatus_t Power_SetParameter( uint8 param, uint8 len, void *value )
{
 ...
 * @return  bStatus_t
 */
bStatus_t Power_GetParameter( uint8 param, void *value )
{
  bStatus_t ret = SUCCESS;
