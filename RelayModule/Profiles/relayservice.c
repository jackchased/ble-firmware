...
#define SENSOR_SERVICE_UUID     RELAY_SERV_UUID
#define SENSOR_DATA_UUID        RELAY_DATA_UUID
#define SENSOR_CONFIG_UUID      RELAY_CONF_UUID
#define SENSOR_PERIOD_UUID      RELAY_PERI_UUID

#define SENSOR_SERVICE          RELAY_SERVICE
#define SENSOR_DATA_LEN         RELAY_DATA_LEN

#define SENSOR_DATA_DESCR       "Relay Status"
#define SENSOR_CONFIG_DESCR     "Relay Conf."
#define SENSOR_PERIOD_DESCR     "Relay Period"
 ...
 */
bStatus_t Relay_AddService( uint32 services )
{
 ...
 */
bStatus_t Relay_RegisterAppCBs( sensorCBs_t *appCallbacks )
{
 ...
 * @return  bStatus_t
 */
bStatus_t Relay_SetParameter( uint8 param, uint8 len, void *value )
{
 ...
 * @return  bStatus_t
 */
bStatus_t Relay_GetParameter( uint8 param, void *value )
{
  bStatus_t ret = SUCCESS;
