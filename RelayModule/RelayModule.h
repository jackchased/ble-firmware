...
#define SBP_READ_AIN_EVT                                  0x0002
#define SBP_READ_POWER_EVT                                0x0004
 ...
 */
extern void RelayModule_Init( uint8 task_id );

/*
 * Task Event Processor for the BLE Application
 */
extern uint16 RelayModule_ProcessEvent( uint8 task_id, uint16 events );
